/*
 *  Sugar Library v1.4.1-custom.1.2.1
 *
...
(function(){
  ...
  function createDate(args, prefer, forceUTC) {
    ...
    if (timezoneString) {
      // transform timezoneJS.Date to Date
      return new Date(Number(getExtendedDate(f, localeCode, prefer, forceUTC, timezoneString).date));
    } else {
